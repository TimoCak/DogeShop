...
if ($stmt->store_result() > 0) {
    while ($stmt->fetch()) {
        ...
        echo "<li id='list-elem' class='card'>"
            . "<form method='post' action='updates/changeTitle.php' class='card-header'><h4>Title:</h4><input name='changeTitle' type='text' value='".$title."'><button name='submit' type='submit' class='btn btn-primary mb-2' value='$productId'>change</button></form><br>
        ...
        <input type='file' class='form-control-file' id='file' name='picture' style='margin-left: 25%'> <br>
        ...
        <button class='btn btn-primary mb-2' type='submit' name='submit' value='$productId'>change</button>
             ...
             "<br><form class='form-group' method='post' action='updates/changeWallet.php'>
              ...
              <button type='submit' name='delete' value='$productId' class='btn btn-outline-danger' style='margin-left: 80%;'>
